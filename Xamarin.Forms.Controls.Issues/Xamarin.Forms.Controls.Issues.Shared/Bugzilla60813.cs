...
namespace Xamarin.Forms.Controls.Issues
{
	...
	[Issue(IssueTracker.Bugzilla, 60813, "[iOS] ListView throws Exception on ObservableCollection.Add/Remove",
		PlatformAffected.iOS)]
	public class Bugzilla60813 : TestNavigationPage
	{
		...
		class ListPage : ContentPage
		{
			public ListPage()
			{
				var listView = new ListView(ListViewCachingStrategy.RecycleElement) {AutomationId = "ListView"};
